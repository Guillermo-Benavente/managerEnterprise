...
export default function ProfileDocument() {
    ...
    return (
        <TemplateBase
            title={['Docmaen', 'Perfil', 'Documento']}
            backNav={`/profile`}
            options={
                <>
                    <Modal
                    ...
                    <Button type={ButtonType.PRIMARY} nav={`/profile/${id}/${documentId}/edit`}>Editar Documento</Button>
                </>
            }
        >
            <PdfViewer fileUrl={GetPdf(FolderType.PROFILES, id, fileName)} showOptions={true} />
        </TemplateBase>
    );
}